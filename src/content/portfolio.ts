...
export const person = {
	...
	valueProp:
		"I run a 33-person Developer Experience / Platform Engineering org at Deloitte and build AI infrastructure hands-on — from multi-tenant Kubernetes platforms to LLM inference systems.",
...
export const about: readonly string[] = [
	"I build and lead platform engineering and developer experience organizations. Today I run a 33-person Developer Experience / Platform Engineering org at Deloitte — four squads with dedicated tech leads — where I treat the internal developer platform as a product serving thousands of engineers across the US Member Firm.",
	...
	"I'm targeting senior roles in engineering management, platform and developer experience, AI forward-deployed / inference platform, and cloud and solutions architecture.",
];
...
export const roles: readonly Role[] = [
	{
		company: "Deloitte",
		title: "Manager, Platform Engineering / Developer Experience",
		period: "2021 – Present",
		highlights: [
			"Built a Developer Experience / Platform Engineering org from scratch: four squads with dedicated tech leads, serving thousands of engineers across the US Member Firm.",
...
export const projects: readonly Project[] = [
	{
		...
		repo: "https://github.com/kornsour/inference-platform",
		aiInfra: true,
	},
	{
		...
		repo: "https://github.com/kornsour/llm-inference-performance",
		aiInfra: true,
	},
	{
		name: "ops-triage-agent",
		description:
			"An enterprise agentic system that triages an IT/Ops queue end to end: retrieves context, drafts grounded responses, and takes guarded actions behind human-approval gates — every release gated by an evaluation harness.",
		tech: ["Python", "FastAPI", "React", "TypeScript", "MCP"],
		repo: "https://github.com/kornsour/ops-triage-agent",
		aiInfra: true,
	},
	{
		name: "micro-ceo",
		...
		repo: "https://github.com/kornsour/micro-ceo",
	},
	{
		name: "design-system",
		description:
		...
		repo: "https://github.com/kornsour/design-system",
	},
	{
		name: "deCuisine",
		description:
		...
		repo: "https://github.com/kornsour/deCuisine",
		live: "https://decuisine.com",
	},
];

export const alsoBuilt: readonly { name: string; repo: string; description: string }[] = [
	{
		name: "graham-crackers",
		repo: "https://github.com/kornsour/graham-crackers",
		description: "Graham-style value-investing analysis tool",
	},
	{
		name: "audiobook-generator",
		repo: "https://github.com/kornsour/audiobook-generator",
		description: "local TTS EPUB-to-M4B pipeline",
	},
	{
		name: "macos-media-scanner",
		repo: "https://github.com/kornsour/macos-media-scanner",
		description: "Photos-library cleanup CLI",
	},
];
